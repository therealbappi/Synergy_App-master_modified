...
public class Paperpresentation_slider extends PagerAdapter {
    private int[] image_resources = {R.drawable.pap2,R.drawable.pap1};
    private Context ctx;
    private LayoutInflater layoutInflater;
    public Paperpresentation_slider(Context ctx){
        this.ctx = ctx;
    }
